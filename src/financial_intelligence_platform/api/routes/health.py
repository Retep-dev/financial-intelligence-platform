...
from financial_intelligence_platform.db.qdrant.collections import validate_collection, COLLECTION_NAME
from financial_intelligence_platform.db.qdrant.metrics import get_collection_stats
