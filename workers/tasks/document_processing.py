...
from db.postgres.models.chunk import ChunkStatus
from db.postgres.session import SessionLocal

from services.ingestion.parsers.parser_router import extract_text
from services.ingestion.service import update_document_status
from services.chunking.chunker import split_into_chunks
from services.chunking.chunk_repository import save_chunks
from services.embeddings.generator import generate_chunk_embeddings

from db.qdrant.collections import ensure_collection_exists
